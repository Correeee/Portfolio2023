...
export const projectsData = [
    ...
    { id: 3, name: 'QRIDs', category: 'Javascript', description: 'Generador y Lector de Códigos QR. Diseñé una interfaz amigable para generar códigos QR y leerlos mediante la cámara. Una característica única es la opción de imprimir un PDF con el QR, creando tarjetas personalizadas.', image: projectImg3, link: 'https://qrids.netlify.app/', backgroundColor: greyBackground },
