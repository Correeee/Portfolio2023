    ...
    return (
        <div className='Footer'>
            ...
            <div className='footer__socials'>
                ...
                <a href='https://drive.google.com/file/d/1qbvCanKRVbjHlDG2bWd7ZSSNsbpeOiiV/view' target='__blank' className="social__links"><img src={cv} alt="Curriculum" className="social__links_img" /></a>
